...
export function AnnouncementBar() {
  return `
    <div class="w-full bg-primary border-b border-primary-container z-50">
      <div class="max-w-container-max mx-auto px-margin-desktop py-2 flex flex-col gap-1 text-center sm:flex-row sm:items-center sm:justify-between sm:gap-4 sm:text-left">
