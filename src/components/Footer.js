    ...
    <footer class="w-full py-16 px-margin-desktop grid grid-cols-1 md:grid-cols-4 gap-gutter bg-primary-container border-t border-on-primary-fixed-variant">
      <div class="col-span-1 md:col-span-1">
        ...
        <div class="flex gap-5 items-center">
          <a class="text-on-primary-container hover:text-tertiary-fixed transition-colors" href="#" aria-label="Facebook" rel="noopener">
          ...
          <a class="text-on-primary-container hover:text-tertiary-fixed transition-colors" href="#" aria-label="Instagram" rel="noopener">
          ...
          <a class="text-on-primary-container hover:text-tertiary-fixed transition-colors" href="#" aria-label="TikTok" rel="noopener">
          ...
          <a class="text-on-primary-container hover:text-tertiary-fixed transition-colors" href="#" aria-label="YouTube" rel="noopener">
